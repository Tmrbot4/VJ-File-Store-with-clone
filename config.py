...
ADMINS = int(environ.get("ADMINS", "6987799874"))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002246550824')).split()]
...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002246892423'))
    ...
    if HAS_SSL:
        URL = "https://vj-file-store-with-clone-a9d2878ef969.herokuapp.com/"
    else:
        URL = "https://vj-file-store-with-clone-a9d2878ef969.herokuapp.com/"
